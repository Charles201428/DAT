...
CLASSIFY_SYSTEM_PROMPT = (
    ...
    "A news item is DAT=TRUE if a named company/entity (preferably public) decides or executes balance-sheet actions involving cryptoassets (BTC, ETH, SOL, BNB, TON, AVAX, etc.), including:\n"
    ...
    "PUBLIC LISTING REQUIREMENT (hard gate)\n"
    "Return DAT=TRUE only if the issuer is a publicly listed company and a valid stock ticker and exchange are identifiable in the article or via authoritative sources. "
    "If the issuer is private, unlisted, or the ticker/exchange cannot be resolved, return DAT=FALSE.\n\n"
